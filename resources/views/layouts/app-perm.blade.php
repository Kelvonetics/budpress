  ...
  <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
    <div class="main-menu-content">
      <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        <li class=" nav-item"><a href="{{url('/home')}}"><i class="la la-home"></i><span class="menu-title" data-i18n="nav.dash.main">Dashboard</span>
        <!-- <span class="badge badge badge-info badge-pill float-right mr-2">3</span>      -->
        </a>     
        </li>

          <li class=" nav-item">
            <a href="{{url('/home')}}"><i class="la la-book"></i><span class="menu-title" data-i18n="nav.templates.main"> Budget  </span></a>     
          </li>

          <li class=" nav-item">
            <a href="{{url('/home')}}"><i class="la la-book"></i><span class="menu-title" data-i18n="nav.templates.main"> Imprests  </span></a>     
          </li>

          <li class=" nav-item">
            <a href="{{url('/home')}}"><i class="la la-book"></i><span class="menu-title" data-i18n="nav.templates.main"> Expenses  </span></a>     
          </li>        

          <li class=" nav-item">
            <a href="#"><i class="la la-list"></i><span class="menu-title" data-i18n="nav.templates.main"> Workflows </span></a>            
            <ul class="menu-content">
              <li> <a href="{{url('/home')}}" class=""> Workflows </a> </li>
              <li> <a href="{{url('/home')}}" class=""> Flows </a> </li>
            </ul>
          </li>          
          ...
          <li class=" nav-item">
            ...
            <ul class="menu-content">
              <li> <a href="{{url('/home')}}" class=""> Staff </a> </li>
              <li> <a href="{{url('/home')}}" class=""> Roles </a> </li>
              <li> <a href="{{url('/home')}}" class=""> Departments </a> </li>
            </ul>
          </li>         
          ...
          <li class=" nav-item">
            ...
            <ul class="menu-content">
              <li> <a href="{{url('/home')}}" class=""> Permissions </a> </li>
