<template>
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header-left col-xl-9 col-md-7 col-sm-12 mb-2 breadcrumb-new">
          <h3 class="content-header-title mb-0 d-inline-block">Imprest Expenses</h3> 
          <div class="row breadcrumbs-top d-inline-block">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">Home</a>
                </li>
                <li class="breadcrumb-item active">Budget - Imprest - Expenses
                </li>
              </ol>
            </div>
          </div>
          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-header">
                <h4 class="card-title">Imprest Expenses</h4>
                            ...
                            <td>
                                ...
                                <span v-if="expense.flow_stage_id === 2"> 
                                    <a class="pull-right" data-toggle="modal" data-target="#approveExpenceModal" title="Review Expence" 
                                        @click="reviewExpense(expense);"><span class="la la-registered text-inverse m-r-10" style="margin :1px 2px; color: #396;"></span>
                                    </a> 
                                </span>
                                ...
                                <span v-else-if="expense.flow_stage_id === 1 || expense.flow_stage_id > 3">
                                    <a class="pull-right"> <span class="la la-list text-inverse m-r-10" style="margin :1px 2px; color:#fff"></span>  </a> 
                                </span>
...
<script>
    export default
    {
        ...
        methods:{
            ...
            {
                let vm = this;
                page_url = page_url || '/api/budget-imprest-expenses?all=1'
                fetch(page_url)
                .then(res => res.json())
                .then(res => {
            ...
            {
                let vm = this;
                page_url = page_url || '/api/budget-imprest-expenses/' + this.$route.params.id,
                fetch(page_url)
                .then(res => res.json())
                .then(res => {
                    this.expenses = res.data;
